...
class GradientDescent(Minimizer):
    ...
    def __init__(self, wrt, f, fprime, steprate=0.1, momentum=0.0,
                 momentum_type='standard', args=None):
		...
		loss : function
			Same as fprime, but returns the loss.
			DH: Doing this so I can monitor loss over time.
        """
    ...
    def __iter__(self):
        ...
        for i, j in enumerate(periterargs):
            ...
            yield dict(gradient=gradient, steprate=steprate,
                       ...
                       momentum=momentum, step=step,loss=loss)
